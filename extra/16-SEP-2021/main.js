$(document).ready(function () {
  ...
  const table = $('#table').DataTable({
    ...
    "rowCallback": function (row, data, index) {
      ...
      if (data['peOptionPremium'] !== 0 && data['peOptionPremium'] > -10 && data['peOptionPremium'] < 10 && data['peOptionLastPrice'] < 400) {
        $('td', row).css('background-color', 'yellow');
      }

      if (data['ceOptionPremium'] !== 0 && data['ceOptionPremium'] > -10 && data['ceOptionPremium'] < 10 && data['ceOptionLastPrice'] < 400) {
